...
input_fpath = "RTCA_new.RTCA.CORS_MILESTONE_5_25_16"

output_dpath = arcpy.env.workspace
output_fname = "CORS_MILESTONE_5_26_16"
...
fm = arcpy.FieldMap()
fm.addInputField(input_fpath,"MilestoneIfOtherExplain")
fms.addFieldMap(fm)
...
fm = arcpy.FieldMap()
fm.addInputField(input_fpath,"MilestoneMeasureIfOtherExplain")
fms.addFieldMap(fm)
...
fm = arcpy.FieldMap()
fm.addInputField(input_fpath,"PhotoAttachment")
fms.addFieldMap(fm)

fm = arcpy.FieldMap()
fm.addInputField(input_fpath,"ProjectSuccessStoryAttachment")
fms.addFieldMap(fm)
